...
def generate_report() -> str:
    ...
    md.append(r"- **Expanded Measurement Uncertainty ($k=2$, 95% Confidence):** Certified at **$\pm 1.66\%$** according to GUM methodology.")
    md.append("")
    md.append("---")
    md.append("")
    ...
    md.append("")
    md.append("Benchmarked against an **IEC 62053-22 Class 0.5S Laboratory Reference Standard** across 3 standardized commercial load bands:")
    ...
    md.append("return 120.0f * (0.15f * norm + 0.85f * norm * norm);")
    md.append("```")
    md.append("")
